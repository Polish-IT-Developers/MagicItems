...
public class BossGUI {
    ...
    public static void OpenBossGUI(Player p) {
        Inventory inv = Bukkit.createInventory(null, 27, ChatColor.translateAlternateColorCodes('&', "&8Bossy..."));
        ...
        inv.setItem(13, SpecialItemManager.necromanceregg);
